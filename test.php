...
<html lang="en">
  ...
  <body class="overflow-x-hidden leading-normal tracking-normal text-indigo-400 m-6 bg-cover bg-fixed" style="background-image: url('header.png');">
    <!-- <div id="loading" class="h-screen w-screen flex absolute top-0 right-0 left-0 bottom-0 bg-black z-20">
      <img src="./img/delivery.png" class="grow mx-auto">
    </div> -->
    <div class="h-full pr-10 pl-10">
      ...
      <div class="w-full container mx-auto">
        <div class="w-full flex items-center justify-between">
          ...
          <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="/delivery/loginadmin.php">
          <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500"> Price</span>
          </a>
          <a class="flex items-center text-indigo-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="/delivery/loginadmin.php">
            President's <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-pink-500 to-purple-500"> Pick-up</span>
          </a>
      ...
      <div class="container pt-18 md:pt-18 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full xl:w-2/5 justify-center lg:items-start">
          ...
          <form method="post" class="bg-gray-900 opacity-75 w-full shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
            <div class="mb-4">
    ...
    <!-- Table Header -->
            <thead>
              ...
              <tr class="border-b border-gray-200 bg-gray-200 ">
                ...
                <th class="p-3 text-gray-700 font-semibold text-sm tracking-wider uppercase text-left">
                  Sender Name
                </th>
                <th class="p-3 text-gray-700 font-semibold text-sm tracking-wider uppercase text-left">
                  Recipient Name
...
<!-- This is an example component -->
                <div class=" mx-auto text-white w-full py-10 pt-20">
                  <div class="text-center">
                    <h3 class="text-3xl mb-3 text-white font-bold"> Visit Our Booth</h3>
                  ...
                  <div class="mt-10 flex flex-col md:flex-row md:justify-center items-center text-sm text-gray-400">
                      <p class="order-2 md:order-1 mt-8 md:mt-0 "> &copy; Muhammad Alief Firmanda</p>
                  </div>
              </div>
          </div>
      </div>
